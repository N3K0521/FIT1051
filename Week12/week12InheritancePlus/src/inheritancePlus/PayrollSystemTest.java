	...
	public static void main( String[] args )
     {
        ...
        SalariedPlusOnCallEmployee salariedPlusOnCallEmployee = new SalariedPlusOnCallEmployee("John", "Callin", "555-555-5555", 2000, new double[]{0.0, 0.0, 4.0, 0.0, 0.0, 0.0, 2.0});
        ...
        System.out.printf( "%s\n%s: $%,.2f\n\n", salariedPlusOnCallEmployee, "earned", salariedPlusOnCallEmployee.earnings());
        ...
        employees[ 4 ] = salariedPlusOnCallEmployee;
