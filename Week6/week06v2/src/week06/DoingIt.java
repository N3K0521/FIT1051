...
public class DoingIt {
    ...
    private void lab1(){
        ...
        if (coinFlip.equals("H")) {
            myWindow.writeOutLine("Head");
        } else if (coinFlip.equals("T")) {
            myWindow.writeOutLine("Tail");
        } else if (coinFlip.equals("h")) {
            myWindow.writeOutLine("Head");
        } else if (coinFlip.equals("t")) {
            myWindow.writeOutLine("Tail");
        } else
        ...
        //Test Case 2
        String coinFlip2 = new String("H");
        if (coinFlip2.equals("H")) {
            myWindow.writeOutLine("Head");
        } else if (coinFlip2.equals("T")) {
            myWindow.writeOutLine("Tail");
        } else if (coinFlip2.equals("h")) {
            myWindow.writeOutLine("Head");
        } else if (coinFlip2.equals("t")) {
            myWindow.writeOutLine("Tail");
        } else
        ...
        //Test Case 3
        String coinFlip3 = new String("t");
        if (coinFlip3.equals("H")) {
            myWindow.writeOutLine("Head");
        } else if (coinFlip3.equals("T")) {
            myWindow.writeOutLine("Tail");
        } else if (coinFlip3.equals("h")) {
            myWindow.writeOutLine("Head");
        } else if (coinFlip3.equals("t")) {
            myWindow.writeOutLine("Tail");
        } else
...
public class Lab1 {
    public static void main(String[] args) {
        String coinFlip = new String();
        if (coinFlip.equals("h") || coinFlip.equals("H")) {
            System.out.println("Head");
        } else if (coinFlip.equals("t") || coinFlip.equals("T")) {
...
*/
    ...
    private void lab2(){
        //Test Case 1
        myWindow.clearOut();
        String coinFlip = new String("head");
        if (coinFlip.equals("")) {
...
public class Lab2 {
    public static void main(String[] args) {
        ...
        } else if (coinFlip.equals("h") || coinFlip.equals("H")) {
            System.out.println("Head");
        } else if (coinFlip.equals("t") || coinFlip.equals("T")) {
            System.out.println("Tail");
        } else
